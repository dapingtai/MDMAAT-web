      ...
      tabItem(
        ...
        fluidRow(
          box(collapsible = TRUE,
              ...
              fluidRow(
                column(3, offset = 0, img(src='EXAMPLE/Plot/P1.png', align = "center", width = '95%')),
                column(3, offset = 0, fluidRow( 
                  img(src='EXAMPLE/Plot/P2.png', align = "center", width = '95%'),
                  img(src='EXAMPLE/Plot/P3.png', align = "center", width = '95%')
                )),
                column(2, offset = 0, img(src='EXAMPLE/Plot/P4.png', align = "center", width = '90%')),
                column(3, offset = 0, fluidRow(
                  img(src='EXAMPLE/Plot/P5.png', align = "center", width = '95%'),
                  img(src='EXAMPLE/Plot/P6.png', align = "center", width = '95%')
                ))
              )
          )
        ),
