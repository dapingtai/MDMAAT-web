              ...
              fluidRow(
                box(width = 12, title = strong("WELCOME TO MIB PROJECTS AND DATABASES WEBAPP"), collapsible = FALSE, status = "success", solidHeader = TRUE,
                    ...
                    h4('This web app is created for tracking the project progress and providing a simple viewer for the processed data.
                       Each project page consists of seven panels:'),
                    ...
                    h4(strong('6. GROUP COMPARSION')),
                    h4('It is a analysis tool to compare two group. You can see the different expression gene in the result page.'),
                    h4(strong('7. GROUP COMPARSION VIEWER')),
                    h4('It shows the visualization of group comparsion result. In addiotion, You can try enrichment analysis with your result'),
                    p('Contact Hung Chang / Sheng-Hui Lu ',
                      a('zero102x@gmail.com'),'/',
      ...
      tabItem(
        ...
        fluidRow(
          box(collapsible = TRUE,
              ...
              fluidRow(
                column(3, offset = 0, img(src='TEMPLATE/Plot/P1.png', align = "center", width = '95%')),
                column(3, offset = 0, fluidRow( 
                  img(src='TEMPLATE/Plot/P2.png', align = "center", width = '95%'),
                  img(src='TEMPLATE/Plot/P3.png', align = "center", width = '95%')
                )),
                column(2, offset = 0, img(src='TEMPLATE/Plot/P4.png', align = "center", width = '90%')),
                column(3, offset = 0, fluidRow(
                  img(src='TEMPLATE/Plot/P5.png', align = "center", width = '95%'),
                  img(src='TEMPLATE/Plot/P6.png', align = "center", width = '95%')
                ))
              )
          )
        ),
